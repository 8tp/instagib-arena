...
export const HATS: readonly HatCosmetic[] = [
  ...
  { id: 'hat.baseball',   name: 'Ballcap Pro',    blurb: 'The fitted classic.',                    rarity: 'common', source: { type: 'level', level: 2 },     model: `${HAT_DIR}/baseball-cap.glb`, fit: 1.15, sink: 0.04, yaw: Math.PI },
