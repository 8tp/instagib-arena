...
agree to the following terms for all past and future Contributions.
...
- **"Contribution"** means any original work of authorship — code, documentation,
  assets, or other material — that you intentionally submit to the Project.
...
You agree that the Maintainer may license your Contribution under the AGPL-3.0, and
**may also relicense and sublicense your Contribution under other terms, including
proprietary/commercial licenses**, as part of the Project. This dual-licensing
right is the core purpose of this Agreement.
...
Contribution alone or by its combination with the Project. If any entity initiates
patent litigation alleging that the Project or a Contribution infringes a patent,
the patent licenses granted under this Agreement for that Contribution terminate for
that entity.
...
2. You are legally entitled to grant the above licenses. If your employer has rights
   ...
   waived such rights.
3. Your Contribution does not, to your knowledge, violate any third party's rights.

## 5. No obligation; "as is"

You understand that the decision to include your Contribution in the Project is
entirely at the Maintainer's discretion. You provide your Contributions on an "AS
IS" basis, without warranties of any kind, except as required by law.

## 6. You retain your rights

You retain all right, title, and interest in your Contributions. This Agreement
grants licenses to the Maintainer; it does not transfer ownership.
